...
import { Box, Card, CardMedia, CardContent, CardActions, Chip, Typography, Button } from '@material-ui/core';
            ...
            <CardContent>
                ...
                {place?.address && (
                    <Typography gutterBottom variant="body2" color="textSecondary" className={classes.subtitle}>
                        <LocationOnIcon /> <span style={{ float: 'right' }}>{place?.address}</span>
                    </Typography>
                )}
                {place?.phone && (
