...
const Map = ({ setCoordinates, setBounds, coordinates, places, setChieldClicked }) => {
    ...
    return (
        <div className={classes.mapContainer}>
            <GoogleMapReact
                bootstrapURLKeys={{ key: 'AIzaSyBjqC4J3ncZ4SpgyDNTBPZ0x0jxIXLZy68' }}
                ...
                onChildClick={(child) => setChieldClicked(child)}
            >
                {places?.map((place, i) => (
                    <div
